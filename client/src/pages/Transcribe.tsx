...
export default function Transcribe() {
  ...
  return (
    <>
      <Head>
        <title>Transcribe Audio | Web Audio Transcriber</title>
        <meta name="description" content="Transcribe audio files with advanced options" />
      </Head>
        ...
        <Card className="border border-border bg-card/50">
          <CardContent className="pt-6">
            {transcriptionStatus === "idle" ? (
              ...
              // Success state - pass transcription data to the result component
              transcriptionData && (
                <TranscriptionResult 
